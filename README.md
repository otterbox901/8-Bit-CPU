...
├── 8-bit cpu.kicad_pcb     KiCad PCB layout (components placed, routing pending)
...
1. Finish routing the board
2. Burn the generated control ROM contents onto the EEPROMs
3. Bring-up and testing
4. Print and test on physical hardware
